...
function houseAtt (){
    ...
    var topHouseAtt = document.getElementById("topHouseAtt");
    ...
    for (var i=0; i<topMembers.length; i++){
        ...
        topHouseAtt.appendChild(row);
    }

//Bottom 10%

    var bottHouseAtt = document.getElementById ("bottHouseAtt");
