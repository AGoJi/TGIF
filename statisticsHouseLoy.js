...
//For with an Object to add .js to .html:
    ...
    var houseGlance = document.getElementById("HouseAtGla");
    ...
    for (var party in statistics){
        ...
        houseGlance.appendChild(row);
    }

}

//HOUSE LOYALTY TABLES
...
function houseLoy (){
    ...
    var topHouseLoy = document.getElementById("topHouseLoy");
    ...
    for (var i=0; i<topMembers.length; i++){
        ...
        topHouseLoy.appendChild(row);
    }

//Bottom 10%

    var bottHouseLoy = document.getElementById ("bottHouseLoy");
